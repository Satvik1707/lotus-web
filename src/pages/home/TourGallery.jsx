        ...
        <Container fluid className="px-20 testimonials__wrapper" style={{"display":"flex","justifyContent":"center"}}>
          ...
          <figure className="snip1533">
            <figcaption>
              <blockquote>
                <p>
                I am fan of this site, first time I have booked tour for Dubai and He provide the Amazing Tour with   budget price. Thanks lotus tours and events team and I will suggest to my friends and relative to book this company. This was really amazing experience
                </p>
              </blockquote>
              <h3>
RAJENDER SINGH
